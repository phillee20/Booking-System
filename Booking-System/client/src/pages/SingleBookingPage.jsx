  ...
  useEffect(() => {
    if (id) {
      axios.get("/bookings").then((response) => {
        const userBooking = response.data.find(({ _id }) => _id === id);
  ...
  return (
    <div>
      ...
      <div className="bg-gray-200 p-4 mb-4 rounded-2xl">
        ...
        <div className="border-t border-gray-300 mt-2 py-2 flex gap-2">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
        ...
        <div className="font-bold mt-2"> Total price: £{booking.price}</div>
      </div>
